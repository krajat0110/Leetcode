...
$(document).ready(function () {
    ...
    function changeHeader(ele) {
        ...
        $(".selector-font-family").val(cellInfo["font-family"]);
        $(".selector-font-family").css("font-family", cellInfo["font-family"]);
        $(".selector-font-size").val(cellInfo["font-size"]);
    }
...
$(".selector-font-family").change(function () {
    updateCell("font-family", $(this).val());
    $(".selector-font-family").css("font-family", $(this).val());
});

$(".selector-font-size").change(function () {
      ...
      $(".sheet-rename").click(function () {
            ...
            $(".sheet-delete").click(function(){
               if(Object.keys(cellData).length > 1){
                   ...
                   alert("waning : There is only one sheet");
               }
            })
        }
